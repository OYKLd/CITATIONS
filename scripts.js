...
function displayNewQuote() {
    ...
    // Mettre à jour le lien de partage Twitter
    updateTwitterLink(quote);
}

// Fonction pour mettre à jour le lien de partage Twitter
function updateTwitterLink(quote) {
...
// Événement pour le bouton Twitter (ouverture dans un nouvel onglet)
